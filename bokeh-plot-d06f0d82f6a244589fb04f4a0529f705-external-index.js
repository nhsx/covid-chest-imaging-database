(function() {
  var fn = function() {
    ...
    (function(root) {
      ...
      var element = document.getElementById("bcbe087b-499b-4b82-a880-6d4ab9481f42");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'bcbe087b-499b-4b82-a880-6d4ab9481f42' but no matching script tag was found.")
        }
