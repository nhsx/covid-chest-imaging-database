(function() {
  var fn = function() {
    ...
    (function(root) {
      ...
      var element = document.getElementById("6555e280-57e5-434e-9a7a-75814a5f5ae1");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid '6555e280-57e5-434e-9a7a-75814a5f5ae1' but no matching script tag was found.")
        }
