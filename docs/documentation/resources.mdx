...
summary: 'We have created a data cleaning
pipeline in the form of a Python library, 
which can be used to clean the accompanying clinical
...
have both files, but their status file can be ignored.